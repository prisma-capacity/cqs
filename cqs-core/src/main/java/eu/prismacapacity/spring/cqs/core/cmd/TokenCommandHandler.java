 ...
 */
package eu.prismacapacity.spring.cqs.core.cmd;

import lombok.NonNull;

/**
 * A command handler that returns just a token as a response. Should be used if you need an
 * indication token, only.
 */
