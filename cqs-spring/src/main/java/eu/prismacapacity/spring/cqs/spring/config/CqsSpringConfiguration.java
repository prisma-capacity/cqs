 ...
 */
package eu.prismacapacity.spring.cqs.spring.config;
...
import eu.prismacapacity.spring.cqs.spring.cmd.CommandExecutor;
import eu.prismacapacity.spring.cqs.spring.cmd.DefaultCommandExecutor;
import eu.prismacapacity.spring.cqs.spring.query.DefaultQueryExecutor;
import eu.prismacapacity.spring.cqs.spring.query.QueryExecutor;
