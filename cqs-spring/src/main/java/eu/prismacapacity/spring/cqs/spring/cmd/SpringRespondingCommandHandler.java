 ...
 */
package eu.prismacapacity.spring.cqs.spring.cmd;

import eu.prismacapacity.spring.cqs.core.cmd.Command;
import eu.prismacapacity.spring.cqs.core.cmd.CommandHandlingException;
import eu.prismacapacity.spring.cqs.core.cmd.CommandValueResponse;
import eu.prismacapacity.spring.cqs.core.cmd.RespondingCommandHandler;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.lang.NonNull;

public abstract class SpringRespondingCommandHandler<C extends Command, T>
  ...
  protected abstract CommandValueResponse<T> doHandle(C cmd) throws CommandHandlingException;
