 ...
 */
package eu.prismacapacity.cqs.aop.config;

import eu.prismacapacity.cqs.aop.cmd.CommandHandlerOrchestrationAspect;
import eu.prismacapacity.cqs.aop.query.QueryHandlerOrchestrationAspect;
