 ...
 */
package eu.prismacapacity.cqs.aop.cmd;
...
import eu.prismacapacity.cqs.core.cmd.ICommandHandler;
...
public class CommandHandlerOrchestrationAspect {
  ...
  private static final String PC_COMMAND_HANDLER =
      "execution(* eu.prismacapacity.cqs.core.cmd.CommandHandler+.handle(..))";
  private static final String PC_RESPONDING_COMMAND_HANDLER =
      "execution(* eu.prismacapacity.cqs.core.cmd.RespondingCommandHandler+.handle(..))";
  private static final String PC_TOKEN_COMMAND_HANDLER =
      "execution(* eu.prismacapacity.cqs.core.cmd.TokenCommandHandler+.handle(..))";
