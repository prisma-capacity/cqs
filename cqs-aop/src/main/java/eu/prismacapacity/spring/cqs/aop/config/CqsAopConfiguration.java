 ...
 */
package eu.prismacapacity.spring.cqs.aop.config;

import eu.prismacapacity.spring.cqs.aop.cmd.CommandHandlerOrchestrationAspect;
import eu.prismacapacity.spring.cqs.aop.query.QueryHandlerOrchestrationAspect;
import eu.prismacapacity.spring.cqs.core.metrics.CommandMetrics;
import eu.prismacapacity.spring.cqs.core.metrics.CqsMetrics;
import eu.prismacapacity.spring.cqs.core.metrics.QueryMetrics;
...
public class CqsAopConfiguration {
  ...
  public CommandHandlerOrchestrationAspect commandHandlerOrchestrationAspect(
      Validator validator, CommandMetrics metrics) {
    return new CommandHandlerOrchestrationAspect(validator, metrics);
  }

  @Bean
  public QueryHandlerOrchestrationAspect queryHandlerOrchestrationAspect(
      Validator validator, QueryMetrics metrics) {
    return new QueryHandlerOrchestrationAspect(validator, metrics);
  }
