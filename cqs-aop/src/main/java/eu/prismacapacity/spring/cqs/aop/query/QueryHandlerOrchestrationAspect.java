 ...
 */
package eu.prismacapacity.spring.cqs.aop.query;
...
import eu.prismacapacity.spring.cqs.core.query.QueryOrchestrationSupport;
...
public final class QueryHandlerOrchestrationAspect {
  ...
  @Around("execution(* eu.prismacapacity.spring.cqs.core.query.QueryHandler.handle(..))")
